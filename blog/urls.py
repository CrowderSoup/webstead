...
urlpatterns = [
    ...
    path("editor/oauth/mastodon/start/", views.mastodon_oauth_start, name="mastodon_oauth_start"),
    path("editor/oauth/mastodon/callback/", views.mastodon_oauth_callback, name="mastodon_oauth_callback"),
    path("editor/oauth/bluesky/start/", views.bluesky_oauth_start, name="bluesky_oauth_start"),
    path("editor/oauth/bluesky/callback/", views.bluesky_oauth_callback, name="bluesky_oauth_callback"),
